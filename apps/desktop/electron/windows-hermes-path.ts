...
export function getVenvSitePackagesEntries(
  ...
  // The target platform determines the venv path grammar. Using the host's
  // default path implementation here makes a forced POSIX resolution on a
  // Windows test host silently turn `/venv/lib/...` into `\\venv\\lib\\...`.
