...
- **baseline qualified at exact head**: `d0ade123c0060503abb1a297cd00c602c18b44e6` is green on `Workstation CI` after the fix restoring the browser routing ladder was merged in `1716062f32`;
