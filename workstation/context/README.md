...
13. [`DECISIONS.md`](DECISIONS.md) — settled downstream decisions, including D-018/D-019/D-020/D-021/D-022/D-023/D-024 for Capability Runtime, Experience Compiler, verified Control Plane, operational-admission closure, hierarchical operational knowledge, run-local in-flight operationalization and typed falsifiable verification.
