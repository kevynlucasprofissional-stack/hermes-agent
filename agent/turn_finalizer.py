...
def finalize_turn(
    ...
    if canonical_task_id:
        ...
        admission = admit_completion(str(canonical_task_id), str(canonical_run_id or ""), {
            "session_id": agent._conversation_root_id() or agent.session_id,
            "agent": agent,
            "turn_result": result,
        ...
        if admission.receipt:
            result["work_outcome"] = admission.receipt
