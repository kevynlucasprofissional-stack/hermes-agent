...
def _run_conversation_turn(
    ...
    # Admission runs before context construction, compaction, provider selection, or
    # auxiliary work.  The ingress envelope is stamped by the trusted surface; text is
    # never treated as authority.
    from agent.turn_admission import admit_turn
    from agent.turn_ingress import TurnIngress, TurnOrigin, TurnTrustClass
    ingress = message_envelope or TurnIngress(
    ...
    try:
        ...
        return {"error": "constraint_violation", "final_response": "Turn constraints blocked execution."}
