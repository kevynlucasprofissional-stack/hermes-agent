    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "append": {
                    "type": "boolean",
                    "description": "Whether to append to existing text (default False)",
                    "default": False,
                },
                "mode": {
                    "type": "string",
                    "enum": ["insert_text", "plain_text_paste"],
                    "description": "Input mode: insert_text (keystroke sequence) or plain_text_paste (synthetic clipboard paste event).",
                    "default": "insert_text",
                },
                "semantic_anchor": {
                    "type": "object",
                    "description": "Optional semantic anchor to disambiguate target when layout shifts occur.",
                },
                "text_ref": {
                    "type": "string",
                    "description": "Artifact reference containing text to type (mutually exclusive with text).",
                },
                "artifact_ref": {
                    "type": "string",
...
def browser_type(
    ...
    result = _session._run_browser_command(effective_task_id, cmd, [ref, text])
...
_BROWSER_TOOL_TABLE = (
    ...
    ("browser_type", "⌨️", None, {"ref": "", "text": "", "clear": True, "append": False, "mode": "insert_text", "semantic_anchor": None, "text_ref": None, "artifact_ref": None}),
    ...
    ("browser_read_http", "🌐", None, {"url": "", "method": "GET", "headers": None}),
)
